---
title: "1.2 Tasks: Prometheus in Kubernetes App Monitoring"
weight: 1
sectionnumber: 1.2
---
...
{{< readfile file="/content/en/docs/01/service.yaml" code="true" lang="yaml" >}}
...
{{< readfile file="/content/en/docs/01/baloise_python-deployment.yaml" code="true" lang="yaml" >}}
...
{{< readfile file="/content/en/docs/01/baloise_python-service.yaml" code="true" lang="yaml" >}}
