...
https://raw.githubusercontent.com/puzzle/prometheus-training/main/content/en/docs/01/labs/mariadb.yaml
...
{{< readfile file="/content/en/docs/01/labs/mariadb-sidecar.yaml" code="true" lang="yaml" >}}
...
{{< readfile file="/content/en/docs/01/labs/probe.yaml" code="true" lang="yaml" >}}
