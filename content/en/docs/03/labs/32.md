...
* Navigate to <https://grafana.com/grafana/dashboards/11449> (TODO) and copy the dashboard ID
...
{{% alert title="Note" color="primary" %}}
If there are no results, the Recording Rule from lab 2.4 is missing and needs to be created.
{{% onlyWhen baloise %}}
...
TODO: Probably integrate the following tasks into non-baloise as well
