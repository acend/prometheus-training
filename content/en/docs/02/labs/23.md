...
{{% onlyWhenNot baloise %}}
Execute the queries in the [Thanos Querier UI](https://{{% param thanosquerier %}}).
{{% /onlyWhenNot %}}
{{% onlyWhen baloise %}}
Execute the queries in the [Thanos Querier UI](https://{{% param replacePlaceholder.thanosquerier %}}).
{{% /onlyWhen %}}
