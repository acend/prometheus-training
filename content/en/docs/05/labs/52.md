...
https://raw.githubusercontent.com/puzzle/prometheus-training/main/content/en/docs/05/labs/prometheus-custom-rule.yml
{{% param cliToolName %}} -n monitoring create -f ~/work/prometheus-custom-rule.yml
```

`prometheus-custom-rule.yml` content:
{{< readfile file="/content/en/docs/05/labs/prometheus-custom-rule.yml" code="true" lang="yaml" >}}
