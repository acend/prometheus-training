...
https://raw.githubusercontent.com/puzzle/prometheus-training/main/content/en/docs/05/labs/mailcatcher.yml

{{% param cliToolName %}} -n monitoring create -f ~/work/mailcatcher.yml
```

`mailcatcher.yml` content:
{{< readfile file="/content/en/docs/05/labs/mailcatcher.yml" code="true" lang="yaml" >}}
